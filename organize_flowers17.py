...
input_path  = "/home/ms/workspacePy/CNN_flowers/flower-recognition/jpg"
output_path = "/home/ms/workspacePy/CNN_flowers/flower-recognition/dataset/train"
...
#	print(cur_path)
	...
	for image_path in image_paths[i:j]:
		...
		os.system("cp " + original_path + " " + cur_path + image_path)
	i += 80
	j += 80
	label += 1
